...
//The CanvasRenderingContext2D.lineCap property of the 
//Canvas 2D API determines the shape used to draw the end points of lines.
//设置成圆形
ctx.lineCap = 'round';
...
var loop = function(){
  ...
  window.requestAnimFrame(loop);
	...
	//逐个跟新参数 整个while循环走完一次，画完（走一次画一个点）
	var i = orbs.length;
	while(i--){
		var orb = orbs[i];	
		var updateCount = 3;
